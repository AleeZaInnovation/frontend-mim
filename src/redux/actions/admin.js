...
export const newTransaction = formData => async dispatch => {
  ...
  try {
    ...
    dispatch({ type: 'newTransactionRequest' });
    ...
    dispatch({ type: 'newTransactionSuccess', payload: data?.message });
  } catch (error) {
    dispatch({
      type: 'newTransactionFail',
      payload: error?.response?.data?.message,
    });
  }
};

export const createParty = formData => async dispatch => {
  try {

    dispatch({ type: 'createPartyRequest' });
    ...
    dispatch({ type: 'createPartySuccess', payload: data?.message });
  } catch (error) {
    dispatch({
      type: 'createPartyFail',
      payload: error?.response?.data?.message,
    });
  }
};
